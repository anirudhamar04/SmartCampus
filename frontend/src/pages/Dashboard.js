    ...
    <div className="card p-5">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-primary-100 text-2xl font-semibold mt-1">{value}</p>
        </div>
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <StatCard 
              ...
              icon={icons.users} 
              color="bg-primary-800 text-blue-400" 
            />
            <StatCard 
              title="Active Users" 
              value={stats.activeUsers} 
              icon={icons.active} 
              color="bg-primary-800 text-green-400" 
            />
            <StatCard 
              title="Pending Requests" 
              value={stats.pendingRequests} 
              icon={icons.pending} 
              color="bg-primary-800 text-yellow-400" 
            />
            <StatCard 
              title="Total Services" 
              value={stats.totalServices} 
              icon={icons.services} 
              color="bg-primary-800 text-purple-400" 
            />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <div className="card p-5">
              <h2 className="text-xl font-semibold text-primary-100 mb-4">Recent Activity</h2>
              <div className="space-y-4">
                {[1, 2, 3, 4].map((item) => (
                  <div key={item} className="flex items-start border-b border-primary-700 pb-3 last:border-0">
                    <div className="rounded-full bg-primary-700 h-8 w-8 flex items-center justify-center mr-3">
                      <span className="text-primary-300 text-xs">U{item}</span>
                    </div>
                    <div>
                      <p className="text-primary-200">User logged in</p>
                      <p className="text-primary-400 text-sm">2 hours ago</p>
                    </div>
                  </div>
                ))}
              </div>
